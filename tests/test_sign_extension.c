...
TEST_CASE(test_int16_12bit_negative)
{
        /*
        ...
        test_struct_t data = {.field_int16 = -100};
        ...
        TEST_ASSERT(unpacked.field_int16 == -100);
}

TEST_CASE(test_int16_12bit_positive)
{
        ppack_byte_t payload[PPACK_PAYLOAD_UNITS] = {0};
        test_struct_t data = {.field_int16 = 100};
...
TEST_CASE(test_int32_20bit_negative)
{
        /* -500 in a 20-bit signed field */
        ppack_byte_t payload[PPACK_PAYLOAD_UNITS] = {0};
        test_struct_t data = {.field_int32 = -500};
        ...
        int unpack_ret = ppack_unpack(&unpacked, payload, fields, 1);
        TEST_ASSERT(unpack_ret == PPACK_SUCCESS);
        TEST_ASSERT(unpacked.field_int32 == -500);
}

TEST_CASE(test_int32_1bit_negative)
{
...
{
        run_test(test_int16_12bit_negative, "test_int16_12bit_negative");
        run_test(test_int16_12bit_positive, "test_int16_12bit_positive");
        run_test(test_int32_20bit_negative, "test_int32_20bit_negative");
        run_test(test_int32_1bit_negative, "test_int32_1bit_negative");
}
