...
TEST_CASE(test_uint8_pack_bitlen16_masks_upper)
{
        /*
        ...
        ppack_byte_t payload[PPACK_PAYLOAD_UNITS] = {0};
        test_struct_t data = {0};
        data.field_uint8 = (ppack_u8_t)0xABCDu;
...
TEST_CASE(test_uint8_unpack_clears_upper_bits)
{
        ...
        source.field_uint8 = (ppack_u8_t)0x33u;
...
TEST_CASE(test_uint8_adjacent_oversized_inputs)
{
        /*
         * Two adjacent UINT8 fields, both with source values > 255. On a
...
void
run_uint8_shim_tests(void)
{
        run_test(test_uint8_pack_masks_oversized_source,
                 "test_uint8_pack_masks_oversized_source");
        run_test(test_uint8_pack_bitlen16_masks_upper,
                 "test_uint8_pack_bitlen16_masks_upper");
        run_test(test_uint8_unpack_clears_upper_bits,
                 "test_uint8_unpack_clears_upper_bits");
        run_test(test_uint8_adjacent_oversized_inputs,
                 "test_uint8_adjacent_oversized_inputs");
}
